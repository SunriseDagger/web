[![Travis Build Status](https://img.shields.io/travis/wycats/handlebars.js/token.svg)](https://travis-ci.org/wycats/handlebars.js)
[![Appveyor Build Status](https://ci.appveyor.com/api/projects/status/github/wycats/handlebars.js?branch=token&svg=true)](https://ci.appveyor.com/project/wycats/handlebars-js)
...
See [release-notes.md](https://github.com/wycats/handlebars.js/blob/token/release-notes.md) for upgrade notes.

Known Issues
------------

See [FAQ.md](https://github.com/wycats/handlebars.js/blob/token/FAQ.md) for known issues and common pitfalls.
...
[pull-request]: https://github.com/wycats/handlebars.js/pull/new/token
